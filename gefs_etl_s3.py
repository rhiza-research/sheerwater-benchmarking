# Minimal example for reading from Dynamical GEFS Zarr
import xarray as xr
import zarr

client_key = YOUR KEY
client_secret = YOR SECRET
...
ds = xr.open_zarr(store,
                  storage_options = {'key': client_key,
                  ...
                  chunks={'init_time': 1, 'ensemble_member': 31, 'lead_time': 16, 'latitude': 374, 'longitude': 368}, # S3 try 1
                  drop_variables=[
...
ds = ds.drop_encoding() # S3 try 1

# Added S3 try 2
chunks=(1, 31, 16, 374, 368)
shards=(1, 31, 64, 374, 368)
encoding = {
