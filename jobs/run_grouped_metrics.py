...
start_time, end_time, forecasts, metrics, variables, grids, regions, leads, time_groupings, baselines, parallelism, recompute, backend = parse_args()
...
def run_grouped(combo):
    ...
    try:
        grouped_metric(start_time, end_time, variable, lead, forecast, "era5", metric, spatial=False, time_grouping=time_grouping, grid=grid, region=region,
