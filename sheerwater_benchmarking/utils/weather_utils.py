...
def get_variable(variable_name, variable_type='era5'):
    ...
    variable_ordering = ['sheerwater', 'era5', 'ecmwf_hres', 'ecmwf_ifs_er', 'salient', 'abc']

    weather_variables = [
        # Static variables (2):
        ('z', 'geopotential', 'geopotential', None, None, None),
        ('lsm', 'land_sea_mask', 'land_sea_mask', None, None, None),
        ...
        ("uwind", "u_component_of_wind", "u_component_of_wind", None, None, None),
        ("vwind", "v_component_of_wind", "v_component_of_wind", None, None, None),
        ("hgt", "geopotential", "geopotential", None, None, None),
        ("q", "specific_humidity", "specific_humidity", None, None, None),
        ("w", "vertical_velocity", "vertical_velocity", None, None, None),
    ]
