...
from sheerwater_benchmarking.utils import (dask_remote, cacheable,
                                           ...
                                           shift_forecast_date_to_target_date, lead_to_agg_days)
...
@dask_remote
@cacheable(data_type='array',
           cache_args=['agg_days', 'prob_type', 'grid'],
           cache_disable_if={'grid':'global1_5'},
           chunking={'lat': 121, 'lon': 240, 'lead_time': 14, 'time': 2, 'member': 51})
def fuxi_rolled(start_time, end_time, agg_days=7, prob_type='probabilistic', grid='global1_5'):
    ds = fuxi_gridded(start_time, end_timel, grid)
...
def fuxi(start_time, end_time, variable, lead, prob_type='deterministic',
    ...
    ds = fuxi_rolled(forecast_start, forecast_end, prob_type=prob_type, agg_days=agg_days, grid=grid)
